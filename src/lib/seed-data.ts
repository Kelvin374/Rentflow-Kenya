...
export const rawProperties = [
  { id: 'b0000000-0000-0000-0000-000000000001', name: 'Azure Heights', location: 'Westlands, Nairobi', description: 'Modern residential complex with 24 units in the heart of Westlands.', units: 24, status: 'occupied', landlord_id: 'a0000000-0000-0000-0000-000000000001', payment_info: { mpesaPaybill: '247247', mpesaAccount: 'AZURE01', tillNumber: '123456', bankName: 'Equity Bank', bankAccountName: 'Azure Heights Rent Account', bankAccount: '1002003001' }, created_at: '2024-01-01T00:00:00Z' },
  { id: 'b0000000-0000-0000-0000-000000000002', name: 'Emerald Gardens', location: 'Lavington, Nairobi', description: 'Luxury garden apartments with 24-hour security.', units: 12, status: 'occupied', landlord_id: 'a0000000-0000-0000-0000-000000000001', payment_info: { mpesaPaybill: '247247', mpesaAccount: 'EMERALD02', tillNumber: '123456', bankName: 'Equity Bank', bankAccountName: 'Emerald Gardens Rent Account', bankAccount: '1002003002' }, created_at: '2024-01-01T00:00:00Z' },
  { id: 'b0000000-0000-0000-0000-000000000003', name: 'The Skyview', location: 'Kilimani, Nairobi', description: 'High-rise residential tower with panoramic city views.', units: 36, status: 'occupied', landlord_id: 'a0000000-0000-0000-0000-000000000002', payment_info: { mpesaPaybill: '247247', mpesaAccount: 'SKYVIEW03', tillNumber: '123456', bankName: 'Equity Bank', bankAccountName: 'Skyview Rent Account', bankAccount: '1002003003' }, created_at: '2024-01-01T00:00:00Z' },
  { id: 'b0000000-0000-0000-0000-000000000004', name: 'Kilimani Gardens', location: 'Kilimani, Nairobi', description: 'Quiet residential garden complex near shopping centers.', units: 12, status: 'occupied', landlord_id: 'a0000000-0000-0000-0000-000000000002', payment_info: { mpesaPaybill: '247247', mpesaAccount: 'KILIMANI04', tillNumber: '123456', bankName: 'Equity Bank', bankAccountName: 'Kilimani Gardens Rent Account', bankAccount: '1002003004' }, created_at: '2024-01-01T00:00:00Z' },
  { id: 'b0000000-0000-0000-0000-000000000005', name: 'Westlands Plaza', location: 'Westlands, Nairobi', description: 'Mixed-use commercial and residential building.', units: 8, status: 'occupied', landlord_id: 'a0000000-0000-0000-0000-000000000001', payment_info: { mpesaPaybill: '247247', mpesaAccount: 'WESTLANDS05', tillNumber: '123456', bankName: 'Equity Bank', bankAccountName: 'Westlands Plaza Rent Account', bankAccount: '1002003005' }, created_at: '2024-01-01T00:00:00Z' },
];
...
export const rawMaintenance = [
  { id: 'f0000000-0000-0000-0000-000000000001', tenant_id: 'a0000000-0000-0000-0000-000000000004', unit_id: 'c0000000-0000-0000-0000-000000000001', property_id: 'b0000000-0000-0000-0000-000000000001', category: 'plumbing', description: 'Kitchen Sink Leakage — Major leak under the sink affecting flooring.', priority: 'urgent', status: 'submitted', images: [], progress: 0, created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString() },
  { id: 'f0000000-0000-0000-0000-000000000002', tenant_id: 'a0000000-0000-0000-0000-000000000005', unit_id: 'c0000000-0000-0000-0000-000000000002', property_id: 'b0000000-0000-0000-0000-000000000001', category: 'security', description: 'CCTV Blind Spot — Camera 3 is blocked by overgrown branches.', priority: 'low', status: 'submitted', images: [], progress: 0, created_at: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString() },
  { id: 'f0000000-0000-0000-0000-000000000003', tenant_id: 'a0000000-0000-0000-0000-000000000006', unit_id: 'c0000000-0000-0000-0000-000000000003', property_id: 'b0000000-0000-0000-0000-000000000002', category: 'electrical', description: 'Circuit Breaker Trip — Living room sockets are non-functional.', priority: 'normal', status: 'assigned', assigned_to: 'Musa K. (Electrician)', images: [], progress: 0, created_at: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() },
  { id: 'f0000000-0000-0000-0000-000000000004', tenant_id: 'a0000000-0000-0000-0000-000000000007', unit_id: 'c0000000-0000-0000-0000-000000000004', property_id: 'b0000000-0000-0000-0000-000000000001', category: 'general', description: 'AC Filter Replacement.', priority: 'normal', status: 'in_progress', assigned_to: 'Otieno P. (HVAC)', images: [], progress: 65, created_at: new Date(Date.now() - 48 * 60 * 60 * 1000).toISOString() },
  { id: 'f0000000-0000-0000-0000-000000000005', tenant_id: 'a0000000-0000-0000-0000-000000000004', unit_id: 'c0000000-0000-0000-0000-000000000001', property_id: 'b0000000-0000-0000-0000-000000000001', category: 'general', description: 'Broken Balcony Glass — Replacement installed and sealed.', priority: 'normal', status: 'completed', assigned_to: 'Tech Team', images: [], progress: 100, created_at: new Date(Date.now() - 72 * 60 * 60 * 1000).toISOString(), completed_at: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() },
];
